...
# run this program as $ python TweetsMongoAWS.py
...
def classify_tweet(stemmed_tokens):
    ...
    for token in stemmed_tokens:
        ...
        elif token in st_sadList: emotionCnt['Sad'] +=1
        elif token in st_angerList: emotionCnt['Anger'] +=1
        elif token in st_fearList: emotionCnt['Fear'] +=1
